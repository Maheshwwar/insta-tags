...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
	...
	String sql2="select * from images where username='"+user+"' "; 
	...
	while(rs2.next())
	{
		...
		%>
				...
				<td  width="115" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Tag Name </div></td>
			      ...
			      <td  width="29" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Update</div></td>
				</tr>
					<%}%>
