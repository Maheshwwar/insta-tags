...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">View User Profile Details !!! </p>
          <div class="clr"></div>
          <p>
		  <table width="620" border="1.5"  cellpadding="0" cellspacing="0"  >
					...
					%>
                     ...
                     <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>" style="width:200px; height:200px;"/></div></td>
                        ...
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style9 style10">User Group</div></td>
						  <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s1);%></div></td>
					    </tr>
                        <tr>
					      <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style11">User Name</div></td>
					      <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s2);%></div></td>
					    </tr>
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style11">E-Mail</span></td>
						  <td  width="195" valign="middle" align="center" height="48" ><%out.println(s3);%></td>
					    </tr>
                        <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style11">Mobile</span></td>
						  <td  width="195" valign="middle" align="center" height="51"><%out.println(s4);%></td>
					    </tr>
						 <tr>
							  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style11">Date of Birth</span></td>
						   <td  width="195" valign="middle" align="center" height="51"><%out.println(s5);%></td>
					    </tr>
                        <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style11">Address</span></td>
