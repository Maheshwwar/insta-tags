...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">View Image Details !!! </p>
          <div class="clr"></div>
          <p>
...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
                    ...
                    <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="image"%>" style="width:200px; height:200px;"/></div></td>
                        ...
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style12">Uploaded User</div></td>
						  <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s1);%></div></td>
					    </tr>
                        <tr>
					      <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style12">User Group</div></td>
					      <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s2);%></div></td>
					    </tr>
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Image Name</span></td>
						  <td  width="195" valign="middle" align="center" height="48" ><%out.println(s3);%></td>
					    </tr>
                        <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Tag Name</span></td>
						  <td  width="195" valign="middle" align="center" height="51"><%out.println(ds4);%></td>
					    </tr>
						 <tr>
							  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Use</span></td>
						   <td  width="195" valign="middle" align="center" height="51"><%out.println(ds5);%></td>
					    </tr>
                        <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Color</span></td>
						  <td  width="195" valign="middle" align="center" height="51"><%out.println(ds6);%></td>
					    </tr>
						 <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Description</span></td>
						  <td  width="195" valign="middle" align="center" height="51"><%out.println(ds7);%></td>
					    </tr>
						 <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Date </span></td>
						  <td  width="195" valign="middle" align="center" height="51"><%out.println(s8);%></td>
					    </tr>
						 <tr>
						  <td  width="179" height="51" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><span class="style12">Rank </span></td>
                    ...
                    <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="image"%>" style="width:200px; height:200px;"/></div></td>
                        ...
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style9 style11">Uploaded User</div></td>
						  <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s1);%></div></td>
					    </tr>
                        <tr>
					      <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style12">User Group</div></td>
		  ...
		  <form id="form1" name="form1" method="post" action="updaterank.jsp?id=<%=i%>&itype=<%="dislike"%>&itype1=<%="intra"%>&imgname=<%=s3%>&key=<%=key%>">
		  	<tr>
			    <td  width="282" height="59" align="left" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="center" class="style13">Reason</div></td>
		...
		<%}%>
					...
					while( rs1.next() )
					{
						...
						<tr>
						  <td  width="235" height="26" align="left" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="center" class="style13">Username</div></td>
							<td  width="365" height="26" align="left" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><span class="style13">Reason</span></td>					                        
						</tr>
						<%
						}m=1;
					%>
	  ...
	  <td width="162" align="center" valign="middle"><div align="center"><a href="u_imgdetails.jsp?id=<%=id%>&dislike=<%="dislike"%>&key=<%=key%>"> Unlike</a></div></td></h3>
        ...
        <div class="article">
          <div align="right"><a href="searchimgresults.jsp?key=<%=key%>">Back</a>          </div>
