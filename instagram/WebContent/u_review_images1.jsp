...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3"><span class="style4">Enter Your Review Here !!! </span></p>
          <div class="clr"></div>
          <p align="justify">&nbsp;</p>
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		try
		{
			...
			String sql1="insert into reviews(id,iname,review,uname,dt)values('"+id+"','"+iname+"','"+review+"','"+user1+"','"+dt+"')"; 
        ...
        <div class="article">
          <h2><span class="style4">Image Reviewed Successfully !!!</span></h2>
          <p>&nbsp;</p>
