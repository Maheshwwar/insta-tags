...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
					...
					%>
                     ...
                     <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="image"%>" style="width:200px; height:200px;"/></div></td>
                        ...
                        <tr>
						  <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style9 style10">Uploaded User</div></td>
						  <td  width="195" valign="middle" align="center" height="48" ><div><%out.println(s1);%></div></td>
					    </tr>
                        <tr>
					      <td  width="179" height="48" align="center" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div class="style11">User Group</div></td>
