...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3 style7 style10">Add Images !!!  </p>
          <div class="clr"></div>
          <p>
	      <form action="insertimage.jsp" method="post" enctype="multipart/form-data">
					  ...
					  <table width="420">
					    <tr>
                          <td width="182" height="43" bgcolor="#FF0000"><span class="style12">Image title</span><span class="style11">*</span></td>
                          <td width="226"><input id="imgname" name="imgname" class="text" style="width:175px;" /></td>
                        </tr>
                        <tr>
                          <td height="43" bgcolor="#FF0000"><span class="style12">Tag name</span><span class="style11">(<span class="style13">Min 15 words</span>)*</span> </td>
                          <td><input id="tname" name="tname" class="text" style="width:175px;" /></td>
                        </tr>
                        <tr>
                          <td height="43" bgcolor="#FF0000"><span class="style12">Image uses</span><span class="style11">*</span></td>
                          <td><input id="use" name="use" class="text" style="width:175px;" /></td>
                        </tr>
                        <tr>
                          <td height="43" bgcolor="#FF0000"><span class="style12">Image Color</span> <span class="style11">*</span> </td>
                          <td><input id="color" name="color" class="text" style="width:175px;"/></td>
                        </tr>
                        <tr>
                          <td height="43" bgcolor="#FF0000"><span class="style12">Description</span><span class="style11">*</span></td>
                          <td><textarea name="des" rows="3" cols="23"></textarea></td>
                        </tr>
                        <tr>
                          <td height="43" bgcolor="#FF0000"><span class="style12">Select Image</span><span class="style11">*</span></td>
