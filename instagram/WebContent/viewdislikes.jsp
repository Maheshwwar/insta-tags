    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost style3"> View All Disliked Images !!! </p>
          <div class="clr"></div>
          <p>
...
try 
{
	...
	while ( rs.next() )
	{
		...
		if(m==0){
			...
			<tr>
			<td width="87" height="44" align="center" valign="middle" bgcolor="#FF0000"><span class="style7">Username</span></td>
			
			
			<td width="170" height="44" align="center" valign="middle" bgcolor="#FF0000"><p class="style7">Reason</p>			  </td>
			<td width="119" align="center" valign="middle" bgcolor="#FF0000"><span class="style7">Date on Dislike</span></td>
			</tr>
			<%}m=1;%>
			<tr>
