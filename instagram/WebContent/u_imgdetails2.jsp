...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
		  ...
		  <form id="form1" name="form1" method="post" action="updaterank1.jsp?id=<%=i%>&itype=<%="dislike"%>&imgname=<%=s3%>">
		  	<tr>
				  <td  width="282" align="left" valign="middle" height="59" style="color: #00CC99;"><div align="center" class="style13">Reason</div></td>
		...
		<%}%>
					...
					while( rs1.next() )
					{
						...
						<tr>
						  <td  width="235" align="left" valign="middle" height="26" style="color: #00CC99;"><div align="center" class="style13">Username</div></td>
							<td  width="365" align="left" valign="middle" height="26" style="color: #00CC99;"><span class="style13">Reason</span></td>					                        
						</tr>
						<%
						}m=1;
					%>
